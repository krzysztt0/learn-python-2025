...
If you had some difficulties with the instructions above, that could not be resolved during the exercise, [head here](./exercise09_justsoup.md) for a minimal version of the instructions. (To ONLY install beautifulsoup4 in your base environment)