...
If you tried to follow [the instructions for working with conda environments](./exercise09_conda.md) but got lost on the way and just want to install the beautifulsoup4 package (we will use it for the e-learning session in lecture 10): below you find **minimal** instructions.
